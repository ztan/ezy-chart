...
/***/ "./dist/ezy-chart/fesm5/ezy-chart.js":
/*!*******************************************!*\
  !*** ./dist/ezy-chart/fesm5/ezy-chart.js ***!
  \*******************************************/
/*! exports provided: CHART_DEFAULT_COLORS, ChartComponent, ChartsModule, EChartComponent, ɵa */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ɵa", function() { return BaseChart; });
...
/* harmony import */ var lodash_sumBy__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! lodash/sumBy */ "./node_modules/lodash/sumBy.js");
/* harmony import */ var lodash_sumBy__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(lodash_sumBy__WEBPACK_IMPORTED_MODULE_7__);
...
function replaceDefaultColors(colors) {
    Object(lodash__WEBPACK_IMPORTED_MODULE_3__["merge"])(DEFAULT_COLORS, colors);
}
/**
 * \@internal
 * @param {?} definedColors
...
function generateColors(definedColors, totalNum) {
    ...
    if (definedColors.length < totalNum) {
        definedColors = Object(lodash__WEBPACK_IMPORTED_MODULE_3__["concat"])(definedColors, new Array(totalNum - definedColors.length));
    }
    Object(lodash__WEBPACK_IMPORTED_MODULE_3__["each"])(definedColors, (/**
     * @param {?} val
     * @param {?} i
     * @return {?}
     */
...
function generateColorsAsStrings(definedColors, totalNum) {
    return generateColors(definedColors, totalNum).map((/**
     * @param {?} c
     * @return {?}
     */
    function (c) { return "rgba(" + c[0] + ", " + c[1] + ", " + c[2] + ", 0.8)"; }));
}
/**
 * \@internal
 * @param {?} colour
...
function formatChartColorsForData(colors, type) {
    return {
         ...
         * @return {?}
         */
        function (color) { return (type === 'line' ? rgba(color, 0.6) : 'rgba(255, 255, 255, 0.3)'); })),
...
function formatMoney(val, currency, digitInfo) {
    if (val && currency) {
        /** @type {?} */
        var pipe = new _angular_common__WEBPACK_IMPORTED_MODULE_1__["CurrencyPipe"](Object(moment__WEBPACK_IMPORTED_MODULE_11__["locale"])());
...
var BaseChart = /** @class */ (function () {
    function BaseChart(_zone) {
        ...
        this._params = {};
        this._prevParams = {};
        this._wndEvSubs = Object(rxjs__WEBPACK_IMPORTED_MODULE_12__["fromEvent"])(window, 'resize').subscribe((/**
         * @return {?}
         */
        function () {
            _this._resized = true;
    ...
    Object.defineProperty(BaseChart.prototype, "labels", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(BaseChart.prototype, "type", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(BaseChart.prototype, "datasets", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(BaseChart.prototype, "colors", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(BaseChart.prototype, "colorsFor", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(BaseChart.prototype, "ratio", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(BaseChart.prototype, "legend", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(BaseChart.prototype, "currency", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(BaseChart.prototype, "digits", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(BaseChart.prototype, "timeFormat", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(BaseChart.prototype, "percentage", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(BaseChart.prototype, "paramsChanged", {
        get: /**
         * @return {?}
         */
        function () {
            return !Object(lodash__WEBPACK_IMPORTED_MODULE_3__["isEqual"])(this._params, this._prevParams);
        },
        enumerable: true,
        configurable: true
    });
     ...
     * @return {?}
     */
    BaseChart.prototype.isParamChanged = /**
     * @param {?} property
     * @return {?}
     */
    function (property) {
        return !Object(lodash__WEBPACK_IMPORTED_MODULE_3__["isEqual"])(Object(lodash__WEBPACK_IMPORTED_MODULE_3__["get"])(this._params, property), Object(lodash__WEBPACK_IMPORTED_MODULE_3__["get"])(this._prevParams, property));
    };
    /**
     * @return {?}
     */
    BaseChart.prototype.resetParamsChangeState = /**
     * @return {?}
     */
    function () {
        this._prevParams = Object(lodash__WEBPACK_IMPORTED_MODULE_3__["cloneDeep"])(this._params);
    };
    /**
     * @return {?}
     */
    BaseChart.prototype.ngDoCheck = /**
     * @return {?}
     */
    function () {
        if (!this._resized) {
     ...
     * @return {?}
     */
    BaseChart.prototype.ngOnDestroy = /**
     * @return {?}
     */
    function () {
    ...
    function (deferred) {
        ...
        if (this._debounceTimer) {
            clearTimeout((/** @type {?} */ (this._debounceTimer)));
         ...
         */
        function () {
            _this._debounceTimer = setTimeout((/**
             * @return {?}
             */
            function () {
                _this._checkUpdate(_this._resized);
    ...
    BaseChart.propDecorators = {
        ...
        colorsFor: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        ...
        digits: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        options: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        timeFormat: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
    ...
    function (tooltipItem, data) {
        ...
        if (percentage !== 'only') {
            if (currency) {
                ...
                labels.push(new _angular_common__WEBPACK_IMPORTED_MODULE_1__["DecimalPipe"](moment__WEBPACK_IMPORTED_MODULE_11___default.a.locale()).transform(value, digitInfo));
            }
            else {
        ...
        if (percentage) {
            ...
            /** @type {?} */
            var total = lodash_sumBy__WEBPACK_IMPORTED_MODULE_7___default()(dsData, (/**
             * @param {?} d
             * @return {?}
             */
            function (d) { return (typeof d === 'number' ? d : ((/** @type {?} */ (d.y)))); }));
    ...
    function (tooltipItems, data) {
        ...
        if (tooltipItems.length > 0) {
            ...
            if (item.xLabel || (horizontal && item.yLabel)) {
                title = ((/** @type {?} */ ((horizontal ? item.yLabel : item.xLabel)))) || '';
            }
            else if ((labelCount > 0 && item.index) || 0 < labelCount) {
                title = (/** @type {?} */ (labels[item.index || 0]));
            }
        }
...
if (typeof Chart !== 'undefined') {
    Chart.pluginService.register({
         ...
         * @return {?}
         */
        function (chartInstance, chartEvent) {
            var e_1, _a;
            /** @type {?} */
            var legend = ((/** @type {?} */ (chartInstance))).legend;
            /** @type {?} */
            ...
            if (x <= legend.right && x >= legend.left && y <= legend.bottom && y >= legend.top) {
                try {
                    for (var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_2__["__values"])(legend.legendHitBoxes), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var box = _c.value;
...
var ChartComponent = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_2__["__extends"])(ChartComponent, _super);
     ...
     * @return {?}
     */
    ChartComponent.prototype._onDestroy = /**
     * @protected
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    ChartComponent.prototype._checkUpdate = /**
     * @protected
     * @param {?} resized
     * @return {?}
     */
    function (resized) {
        ...
        /** @type {?} */
        var configChanged = JSON.stringify(this._config.options) !== JSON.stringify(this._prevConfig.options) ||
     ...
     * @return {?}
     */
    ChartComponent.prototype._refresh = /**
     * @private
     * @param {?} configChanged
     * @return {?}
     */
    function (configChanged) {
        this._prevConfig = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(this._config);
        ...
        if (configChanged || !this._chart) {
            ...
            /** @type {?} */
            var cfg = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(this._prevConfig);
            this._applyColors(this.colors || [], this.colorsFor || 'auto', (cfg.data || {}).datasets || []);
            this._createNewChart(cfg);
        }
        else {
            this._chart.config.data = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(this._config.data || {});
     ...
     * @return {?}
     */
    ChartComponent.prototype._createNewChart = /**
     * @private
     * @param {?} cfg
     * @return {?}
     */
    function (cfg) {
        ...
        function () {
            /** @type {?} */
            var container = _this._chartContainer.nativeElement;
            /** @type {?} */
            ...
            ((/** @type {?} */ (cfg))).plugins = _this.plugins;
            _this._chart = new Chart(canvas, cfg);
        }));
    };
    /**
     * @private
     * @return {?}
     */
    ChartComponent.prototype._checkSize = /**
     * @private
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    ChartComponent.prototype._applyConfig = /**
     * @private
     * @return {?}
     */
    function () {
        ...
        /** @type {?} */
        var ds = (this._config.data.datasets = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(this.datasets || []));
        if (!ds.some((/**
         * @param {?} d
         * @return {?}
         */
        function (d) { return (d.label ? true : false); }))) {
            if (multiType) {
                this._config.options.legend.display = false;
            }
        }
        /** @type {?} */
        var labels = (this._config.data.labels = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(this.labels || []));
        ((/** @type {?} */ ((this._config.options || {})))).aspectRatio = this.ratio || 2;
        /** @type {?} */
        var legend = this.legend === false ? false : this.legend || 'auto';
        if (typeof legend === 'string' && ['top', 'right', 'bottom', 'left'].indexOf(legend) >= 0) {
            this._config.options.legend.position = (/** @type {?} */ (legend));
        }
        else if (typeof legend === 'boolean') {
            this._config.options.legend.display = legend;
        }
        else if (typeof legend === 'object') {
            this._config.options.legend = (/** @type {?} */ (lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(legend)));
        }
        else if (legend === 'auto') {
            /** @type {?} */
            var multiPoints = ds.every((/**
             * @param {?} d
             * @return {?}
             */
            function (d) { return (d.data || []).length > 1; }));
            ...
            if (multiType) {
                ...
                var axes = {
                    ticks: { callback: (/**
                         ...
                         * @return {?}
                         */
                        function (val) { return formatScale(val, curr_1); }) }
                };
                if (ds.every((/**
                 * @param {?} d
                 * @return {?}
                 */
                function (d) { return _this._isYAxisAllNumbers(d.data || []); }))) {
        ...
        if (this.type === 'line') {
            /** @type {?} */
            var isTimeScale = ds.every((/**
             * @param {?} d
             * @return {?}
             */
            function (d) {
                return (((/** @type {?} */ (d.data))) || []).every((/**
                 * @param {?} item
                 * @return {?}
                 */
                function (item) { return (item.x ? moment__WEBPACK_IMPORTED_MODULE_11___default()(item.x).isValid() : false); }));
            }));
            if (isTimeScale) {
                this._config.options.scales = this._config.options.scales || {};
                /** @type {?} */
                var minTime = lodash_min__WEBPACK_IMPORTED_MODULE_5___default()(lodash_flatMap__WEBPACK_IMPORTED_MODULE_6___default()(ds, (/**
                 * @param {?} d
                 * @return {?}
                 */
                function (d) { return (/** @type {?} */ (d.data)); })).map((/**
                 * @param {?} p
                 * @return {?}
                 */
                function (p) { return moment__WEBPACK_IMPORTED_MODULE_11___default()(p.x); })));
                ds.every((/**
                 * @param {?} d
                 * @return {?}
                 */
        ...
        if (lodash_isEmpty__WEBPACK_IMPORTED_MODULE_8___default()(this._config.options.scales)) {
            this._config.options = lodash_pickBy__WEBPACK_IMPORTED_MODULE_10___default()(this._config.options, (/**
             * @param {?} val
             * @param {?} key
             * @return {?}
             */
            function (val, key) { return key !== 'scales'; }));
        }
        /** @type {?} */
        ...
        if (this.options) {
            lodash_merge__WEBPACK_IMPORTED_MODULE_9___default()(this._config.options, this.options);
        }
    };
    /**
     * @private
     ...
     * @return {?}
     */
    ChartComponent.prototype._isYAxisAllNumbers = /**
     * @private
     * @param {?} data
     * @return {?}
     */
    function (data) {
         ...
         * @return {?}
         */
        function (d) { return !d || typeof d === 'number' || typeof d.y === 'number'; }));
    };
    /**
     * @private
     * @param {?} colors
     ...
     * @return {?}
     */
    ChartComponent.prototype._applyColors = /**
     * @private
     * @param {?} colors
     * @param {?} colorsFor
     * @param {?} datasets
     * @return {?}
     */
    function (colors, colorsFor, datasets) {
        var e_2, _a;
        if (colorsFor === 'auto') {
        ...
        if (colorsFor === 'series') {
            ...
            lodash_merge__WEBPACK_IMPORTED_MODULE_9___default()(datasets, colorGroups);
        }
        else if (colorsFor === 'data') {
            try {
                for (var datasets_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_2__["__values"])(datasets), datasets_1_1 = datasets_1.next(); !datasets_1_1.done; datasets_1_1 = datasets_1.next()) {
                    var ds = datasets_1_1.value;
                    /** @type {?} */
                    var colorGroup = generateColorsByDataPoints(colors, (ds.data || []).length, this.type || 'bar');
                    lodash_merge__WEBPACK_IMPORTED_MODULE_9___default()(ds, colorGroup);
                }
            }
    ...
    ChartComponent.propDecorators = {
        ...
        _chartContainer: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['chartContainer', { read: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], static: true },] }]
    };
...
var EChartComponent = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_2__["__extends"])(EChartComponent, _super);
    function EChartComponent(zone) {
        var _this = _super.call(this, zone) || this;
        _this._echartsOptions = {};
        _this._typeMap = {
            bar: 'bar',
            horizontalBar: 'bar',
            doughnut: 'pie',
     ...
     * @return {?}
     */
    EChartComponent.prototype._checkUpdate = /**
     * @protected
     * @param {?} resized
     * @return {?}
     */
     ...
     * @return {?}
     */
    EChartComponent.prototype._onDestroy = /**
     * @protected
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    EChartComponent.prototype._recalculateSize = /**
     * @private
     * @return {?}
     */
    function () {
            ...
            if (this._chart) {
                ...
                if (this._echartsOptions.legend) {
                    ...
                    if (div.clientWidth <= 240 || div.clientHeight <= 240) {
                        ...
                        opt.legend = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(this._echartsOptions.legend);
                    }
     ...
     * @return {?}
     */
    EChartComponent.prototype._createChart = /**
     * @private
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    EChartComponent.prototype._applyOptions = /**
     * @private
     * @return {?}
     */
    function () {
        ...
        function (v) { return ({
            ...
            type: _this._typeMap[v.type || mainType] || v.type || mainType,
            data: (v.data || ((/** @type {?} */ ([])))).map((/**
             * @param {?} d
             * @return {?}
             */
            function (d) { return _this._mapDataItem(d, _this.timeFormat); }))
        }); }));
        /** @type {?} */
        var isTime = series.some((/**
         * @param {?} s
         * @return {?}
         */
        function (s) { return s.data.some((/**
         * @param {?} d
         * @return {?}
         */
        function (d) { return d.name && moment__WEBPACK_IMPORTED_MODULE_11___default()(d.name).isValid(); })); }));
        /** @type {?} */
        ...
        if (this.currency) {
            valAxis[0].axisLabel = { formatter: (/**
                 * @param {?} value
                 * @return {?}
                 */
                function (value) { return formatScale(value, _this.currency); }) };
        }
        this._echartsOptions = {
            series: series,
            tooltip: tooltip
        ...
        if (mainType === 'horizontalBar') {
            this._echartsOptions.yAxis = (/** @type {?} */ (catAxis));
            this._echartsOptions.xAxis = (/** @type {?} */ (valAxis));
            this._echartsOptions.tooltip['trigger'] = 'axis';
        }
        else if (mainType === 'line' || mainType === 'bar') {
            this._echartsOptions.xAxis = (/** @type {?} */ ((isTime ? timeAxis : catAxis)));
            this._echartsOptions.yAxis = (/** @type {?} */ (valAxis));
            this._echartsOptions.tooltip['trigger'] = 'axis';
        }
        ...
        /** @type {?} */
        var opt = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(this._echartsOptions);
        opt = lodash_merge__WEBPACK_IMPORTED_MODULE_9___default()(opt, this.options);
        this._chart.setOption(opt, true);
    };
    /**
     * @private
     ...
     * @return {?}
     */
    EChartComponent.prototype._mapDataItem = /**
     * @private
     * @param {?} item
     * @param {?} timeFormat
     * @return {?}
     */
    function (item, timeFormat) {
        ...
        if (item.x && moment__WEBPACK_IMPORTED_MODULE_11___default()(item.x).isValid() && typeof item.y === 'number') {
            /** @type {?} */
            var m = moment__WEBPACK_IMPORTED_MODULE_11___default()(item.x);
            return {
                name: moment__WEBPACK_IMPORTED_MODULE_11___default()(item.x).format(timeFormat || 'L'),
     ...
     * @return {?}
     */
    EChartComponent.prototype._definePieShape = /**
     * @private
     * @param {?} series
     * @param {?} labels
     * @param {?} makeDoughnut
     * @return {?}
     */
    function (series, labels, makeDoughnut) {
        /** @type {?} */
        var r = 0;
        /** @type {?} */
        var step = 80;
        ...
        function (s) {
             ...
             * @return {?}
             */
            function (d, i) { return (d.name = labels[i]); }));
            s.radius = [r + "%", r + step - 1 + "%"];
            r = r + step;
            s.label = {
                normal: {
     ...
     * @return {?}
     */
    EChartComponent.prototype._defineColors = /**
     * @private
     * @param {?} series
     * @param {?} pieLike
     * @return {?}
     */
    function (series, pieLike) {
        var _this = this;
        /** @type {?} */
        ...
        if (cf === 'series') {
            /** @type {?} */
            var colors_1 = generateColorsAsStrings(this.colors || [], series.length);
            series.forEach((/**
             * @param {?} s
             * @param {?} i
             * @return {?}
             */
            function (s, i) { return (s['color'] = colors_1[i]); }));
        }
        else if (cf === 'data') {
            series.forEach((/**
             * @param {?} s
            ...
            function (s) {
                /** @type {?} */
                var colors = generateColorsAsStrings(_this.colors || [], s.data.length);
                s.data.forEach((/**
                 * @param {?} d
                 * @param {?} i
                 * @return {?}
                 */
                function (d, i) { return (d.itemStyle = { color: colors[i] }); }));
            }));
        }
    };
    /**
     ...
     * @return {?}
     */
    EChartComponent.prototype._formatTooltip = /**
     * @private
     * @param {?} currencyCode
     * @param {?} percent
     * @param {?} digitInfo
     ...
     * @return {?}
     */
    function (currencyCode, percent, digitInfo, param) {
        /** @type {?} */
        var formatParam = (/**
         * @param {?} p
         * @return {?}
        ...
        function (p) {
            /** @type {?} */
            var l = "<div class=\"ezy-echart-tooltip-item\"><span class=\"ezy-echart-series-indicator\" style=\"background-color: " + p.color + "\"></span>\n\t\t\t " + p.seriesName + ": ";
            /** @type {?} */
            ...
            if (!percentOnly) {
                if (currencyCode) {
                    ...
                    l += new _angular_common__WEBPACK_IMPORTED_MODULE_1__["DecimalPipe"](moment__WEBPACK_IMPORTED_MODULE_11___default.a.locale()).transform(v, digitInfo);
                }
            }
            if (showPercent) {
        ...
        if (lodash_isArray__WEBPACK_IMPORTED_MODULE_13___default()(param)) {
             ...
             * @return {?}
             */
            function (p) { return formatParam(p); })).join('');
        }
        else {
     ...
     * @return {?}
     */
    EChartComponent.prototype._generateLegendOptions = /**
     * @private
     * @param {?} multiSeries
     * @param {?} pieLike
     * @return {?}
     */
    function (multiSeries, pieLike) {
        /** @type {?} */
        ...
        if ((l === 'auto' && (multiSeries || pieLike)) || typeof this.legend === 'string') {
            ...
            if (['left', 'right', 'top', 'bottom'].indexOf((/** @type {?} */ (l))) >= 0) {
                legend.x = l;
            }
    ...
    /** @nocollapse */
    EChartComponent.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"] }
    ]; };
    EChartComponent.propDecorators = {
        _chartContainer: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['chartContainer', { read: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], static: true },] }]
    };
...
var ChartsModule = /** @class */ (function () {
    function ChartsModule(defaultColors) {
        if (defaultColors) {
    ...
    ChartsModule.ctorParameters = function () { return [
        { type: Array, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Optional"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"], args: [CHART_DEFAULT_COLORS,] }] }
    ]; };
    return ChartsModule;
}());
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.addSeries = function () {
        if (this.datasets.length) {
            var data = new Array((this.datasets[0].data || []).length);
            for (var i = 0; i < data.length; i++) {
                data[i] = this._getRandomDataItem(i);
            }
            var ds = { data: data, label: "series " + (this.datasets.length + 1) };
    ...
    AppComponent.prototype.removeData = function () {
        if (this.labels.length > 1) {
            this.labels.pop();
            this.datasets
                .map(function (ds) { return ds.data; })
                .filter(function (d) { return d.length > 1; })
                .forEach(function (d) { return d.pop(); });
        }
    };
    ...
    AppComponent.prototype.chartTypeChanged = function () {
        var _this = this;
        this.colorsFor = 'auto';
        this.timeScale = false;
        this.scaleChanged();
        if (this.type === 'line' && this.engine === 'chartjs') {
            this.datasets.forEach(function (ds) { return _this._configLineSpecificProperties(ds); });
        }
        else {
            this.datasets = this.datasets.map(function (ds) { return lodash__WEBPACK_IMPORTED_MODULE_2__["pick"](ds, 'data', 'label'); });
        }
    };
    AppComponent.prototype.scaleChanged = function () {
        ...
        this.datasets.forEach(function (ds) {
            ...
            data.forEach(function (d, i) {
                if (typeof d === 'number' && _this.timeScale) {
                    data[i] = { y: d, x: moment__WEBPACK_IMPORTED_MODULE_3___default()().add(-i, 'year') };
                }
                else if (!_this.timeScale && typeof d !== 'number') {
                    data[i] = d.y;
                }
            });
        });
    ...
    Object.defineProperty(AppComponent.prototype, "sampleTemplate", {
        get: function () {
            var chartTag = this.engine === 'chartjs' ? 'ezy-chart' : 'ezy-echart';
            var templ = "<" + chartTag + " type=\"" + this.type + "\" [datasets]=\"datasets\"";
    ...
    AppComponent.prototype._configLineSpecificProperties = function (ds) {
        ds.fill = false;
        ds.pointRadius = 8;
        ds.pointHoverRadius = 10;
        ds.lineTension = 0.1;
    };
    AppComponent.prototype._getRandomDataItem = function (dsIndex) {
        var n = Number((Math.random() * 20).toFixed(1));
        if (this.timeScale) {
            return { y: n, x: moment__WEBPACK_IMPORTED_MODULE_3___default()().add(-dsIndex, 'year') };
        }
        else {
            return n;
        }
...
/* harmony import */ var ezy_chart__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ezy-chart */ "./dist/ezy-chart/fesm5/ezy-chart.js");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], ezy_chart__WEBPACK_IMPORTED_MODULE_4__["ChartsModule"]],
            providers: [],
